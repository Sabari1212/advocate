    ...
    <section id='contact' className='flex flex-col h-[80vh] p-5 md:p-0 bg-gray-300  gap-3 justify-center  '>
        ...
        <div  className='md:pl-[600px] pb-5'>
            <form onSubmit={handleSubmit} className='flex flex-col md:w-[400px] gap-2'>
                ...
                <button type='submit' className=' rounded-md bg-blue-600 ml-24 md:ml-36 text-center text-white px-2 w-[100px] py-1 mt-2 md:mt-0 hover:cursor-pointer hover:bg-green-600 hover:duration-500 hover:scale-110 ' >Submit</button>
