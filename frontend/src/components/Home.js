...
const Home = () => {
  return (
    <section id='home' className='flex flex-col justify-start gap-3 items-center h-[55vh] md:h-[50vh]  py-40 pb-5  md:pt-24   p-5 ' >
        ...
        <a href='#contact' className=' rounded-md bg-green-500 p-2 text-white hover:cursor-pointer hover:bg-green-600 hover:duration-500 hover:scale-110 '>Request Consultation</a>
